        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="card team-item text-center rounded overflow-hidden">
                        <div class="rounded-circle overflow-hidden m-4">
                            <img class="img-fluid gambar-team" src="{{ asset('image/nur afifah.jpg') }}"
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="card team-item text-center rounded overflow-hidden">
                        <div class="rounded-circle overflow-hidden m-4">
                            <img class="img-fluid gambar-team" src="{{ asset('image/stev.jpg') }}"
                                alt="Steven Ardi Christanto" />
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="card team-item text-center rounded overflow-hidden">
                        <div class="rounded-circle overflow-hidden m-4">
                            <img class="img-fluid gambar-team" src="{{ asset('image/Achmad Raihan.jpg') }}"
                                alt="Achmad Raihan" />
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="card team-item text-center rounded overflow-hidden">
                        <div class="rounded-circle overflow-hidden m-4">
                            <img class="img-fluid gambar-team" src="{{ asset('image/aldi (1).jpg') }}"
                                alt="Muhitualdi" />
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="card team-item text-center rounded overflow-hidden">
                        <div class="rounded-circle overflow-hidden m-4">
                            <img class="img-fluid gambar-team" src="{{ asset('image/nadim.jpg') }}"
                                alt="Moh.Nadim Fadillah" />
                        </div>
                        <div class="card-body">
